...
public class ArticleConfig {
    ...
    CommandLineRunner commandLineRunner(ArticleRepository repository){
        return args -> {
            ...
            Article rceArticle = new Article("Phát hiện 4 lỗ hổng RCE nghiêm trọng trong Control Web Panel",
                    "https://whitehat.vn/threads/phat-hien-4-lo-hong-rce-nghiem-trong-trong-control-web-panel.17500/",
                    List.of("security", "cwp"),
                    "security", createdAt, updatedAt,
                    Status.COMPLETED, lastTimeRead);


            repository.saveAll(List.of(article, rceArticle));
        };
    }
}
